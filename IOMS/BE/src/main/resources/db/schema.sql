...
INSERT INTO
    sites (
        ...
        site_name,
        location,
        days_for_delivery_by_ship,
        days_for_delivery_by_air,
        status,
        created_by
    )
VALUES (
        'SITE-001',
        'SITE-9001',
        'Ho Chi Minh City Distribution Center',
...
VALUES (
    ...
    (
        ...
        '2025-05-18',
        '2025-05-18',
        'Linh kiện thay thế cho dây chuyền sản xuất',
        'completed',
        'Trần Thị Inspector',
        'Nguyễn Văn Admin',
        NULL,
    ...
    (
        ...
        '2025-05-16',
        NULL,
        'Nhôm cấu trúc - BỊ TỪ CHỐI',
        'rejected',
        'Trần Thị Inspector',
        NULL,
        'Không đạt tiêu chuẩn chất lượng, có vết cấy trầy xước',
        'Phạm Thị Sales',
        '2025-05-13 10:15:00'
    ),
    (
...
VALUES (
        ...
        35,
        0.08,
        'Đang kiểm tra, sẽ hoàn tất vào chiều nay',
        NULL
    ),
    (
        'INS-002',
        ...
        100,
        0.02,
        'Lô hàng đạt chất lượng, chấp nhận toàn bộ',
        '2025-05-17 14:00:00'
    );
...
VALUES (
    ...
    (
        'INS-001',
        '/photos/inspection-002.jpg',
        'Chi tiết sản phẩm hư'
    ),
    (
        'INS-002',
        '/photos/inspection-003.jpg',
        'Relay điều khiển'
    );
...
VALUES (
    ...
    (
        ...
        200,
        150,
        'Đang nhập kho, còn 50 sản phẩm chưa bố trí',
        NULL,
        '2025-05-19 14:15:00'
    );
...
VALUES (
        'warning',
        'Hàng tồn kém',
        'Sản phẩm IT-001 (Màn hình LCD 24 inch) có số lượng âm: -10 pcs',
        '2025-05-19 15:30:00',
        false
    ),
    (
        'info',
        'Đơn hàng mới',
        'Đơn hàng ORD-001 từ Công Ty ABC đã được xác nhận',
        '2025-05-18 09:45:00',
        false
    ),
    (
        'success',
        'Nhập hàng hoàn tất',
        'Lô hàng IMP-002 đã được kiểm tra và nhập kho hoàn tất',
        '2025-05-18 10:30:00',
        true
    ),
    (
        'error',
        'Lô hàng bị từ chối',
        'Lô hàng IMP-003 từ Global Supplies Ltd bị từ chối do không đạt chất lượng',
        '2025-05-13 11:20:00',
        true
    );
